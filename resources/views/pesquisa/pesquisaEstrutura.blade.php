...
<html lang="en">
    <head>
        ...
        <title>Pesquisa de Clima - Perguntas ESTRUTURA</title>
    ...
    <body id="page-top">
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><font size="4">Pesquisa de Clima - Perguntas ESTRUTURA</font></a>
            </div>
        </nav>
        <?php $id_us = $usuario[0]->id; ?> 
        <section class="page-section portfolio" id="portfolio">
            <div class="container"><br><br>
                <h4 class="page-section-heading text-center text-uppercase text-secondary mb-0"><font size="5">Perguntas - ESTRUTURA</font></h4>
				...
				@endif 
                <form action="{{\Request::route('storePergEstrutura')}}" method="POST">
