...
<html lang="en">
    <head>
        ...
        <title>Pesquisa de Clima - Perguntas GESTÃO</title>
    ...
    <body id="page-top">
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><font size="4">Pesquisa de Clima - Perguntas GESTÃO</font></a>
            </div>
        </nav>
        <section class="page-section portfolio" id="portfolio">
            <div class="container"><br><br>
				...
				@endif 
                <form action="{{\Request::route('storePergGestao')}}" method="POST">
