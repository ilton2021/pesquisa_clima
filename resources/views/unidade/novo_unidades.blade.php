...
<html lang="en">
    ...
    <body id="page-top">
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><font size="4">Pesquisa de Clima - Cadastro Unidades</font></a>
            </div>
        </nav>
                ...
                <div class="row justify-content-left">
                    <div class="col-md-40 col-lg-40 mb-12">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">             
                            <form action="{{\Request::route('storeUnidades')}}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <table>
                                <thead>
                                 <tr> 
                                  <td> NOME: </td>
                                  <td> <input type="text" id="nome" name="nome" class="form-control" width="400px" value="" /> </td>
                                 </tr>
                                 <tr> 
                                  <td> SIGLA: </td>
                                  <td> <input type="text" id="sigla" name="sigla" class="form-control" width="400px" value="" /> </td>
                                 </tr>
                                 <tr> 
                                  <td> FOTO: </td>
